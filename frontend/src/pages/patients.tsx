...
export default function Patients() {
  ...
  return (
    <div className="page-enter">
      <PageIntro eyebrow="Sổ theo dõi" title="Danh sách bệnh nhân" description="Search the active census, review risk signals, and open a patient's care context." action={<button onClick={() => setCreateOpen(true)} data-testid="button-create-patient" className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-primary px-4 text-sm font-bold text-primary-foreground shadow-sm transition hover:-translate-y-0.5 hover:bg-primary/90"><Plus className="h-4 w-4" /> Add patient</button>} />
